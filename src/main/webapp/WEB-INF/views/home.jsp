    ...
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="http://memorandum.tk" rel="tooltip" title="Make by DarkHowk" data-placement="bottom" target="_blank">
          akatsukirin Korea Fan Page	asdfasdfasdfasdfasdf
        </a>
            ...
            <div class="col-md-6">
              ...
              <nav class="navbar navbar-expand-lg bg-primary">
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="example-navbar" data-nav-image="${pageContext.request.contextPath}/resources/user/img/blurred-image-1.jpg">
                    <ul class="navbar-nav">
          ...
          <div id="images">
            ...
            <div class="row">
              <div class="col-sm-2">
                ...
                <img src="${pageContext.request.contextPath}/resources/user/img/julie.jpg" alt="Rounded Image" class="rounded">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Image</p>
                <img src="${pageContext.request.contextPath}/resources/user/img/julie.jpg" alt="Circle Image" class="rounded-circle">
              </div>
              <div class="col-sm-2">
                <p class="category">Raised</p>
                <img src="${pageContext.request.contextPath}/resources/user/img/julie.jpg" alt="Raised Image" class="rounded img-raised">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Raised</p>
                <img src="${pageContext.request.contextPath}/resources/user/img/julie.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
              </div>
            </div>
          </div>
        </div>
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                    <img class="d-block" src="${pageContext.request.contextPath}/resources/user/img/bg1.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Nature, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="${pageContext.request.contextPath}/resources/user/img/bg3.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Somewhere Beyond, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="${pageContext.request.contextPath}/resources/user/img/bg4.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
          ...
          <div class="row">
            <div class="col">
              <a href="examples/landing-page.html" target="_blank">
                <img src="${pageContext.request.contextPath}/resources/user/img/landing.jpg" alt="Image" class="img-raised">
              </a>
              <a href="examples/landing-page.html" class="btn btn-simple btn-primary btn-round">View Landing Page</a>
            </div>
            <div class="col">
              <a href="examples/profile-page.html" target="_blank">
                <img src="${pageContext.request.contextPath}/resources/user/img/profile.jpg" alt="Image" class="img-raised">
              </a>
